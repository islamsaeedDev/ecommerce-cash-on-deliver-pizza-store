  ...
  return (
    <div className="p-4">
      ...
      <Form method="POST">
        ...
        <div>
          <button
            className="mt-2 inline-block rounded-full bg-fuchsia-400 px-2 py-1 text-sm font-semibold capitalize tracking-wider text-stone-800 shadow-md transition-colors duration-300 hover:bg-fuchsia-500 focus:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 focus:ring-offset-yellow-200 disabled:cursor-not-allowed"
