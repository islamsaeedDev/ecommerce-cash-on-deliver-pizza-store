  ...
  return (
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          <button
            className="mt-4 rounded-full bg-fuchsia-400 px-6 py-3 text-lg font-semibold uppercase text-stone-800 transition hover:bg-fuchsia-500 disabled:cursor-not-allowed disabled:opacity-50"
