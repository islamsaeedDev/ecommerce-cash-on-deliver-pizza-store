  ...
  return (
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          <button
            className="m-4 inline-block bg-fuchsia-400 px-2 py-1 text-sm font-semibold capitalize tracking-wide text-stone-800 transition hover:bg-fuchsia-500 disabled:cursor-not-allowed disabled:opacity-50"
