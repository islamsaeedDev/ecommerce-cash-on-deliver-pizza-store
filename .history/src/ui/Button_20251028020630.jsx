...
function Button({ children, to, type, disabled }) {
  ...
  const styles = {
    ...
    secondary:
      'mt-2 inline-block rounded-full bg-stone-400 text-sm font-semibold capitalize tracking-wider text-stone-800 shadow-md transition-colors duration-300 hover:bg-fuchsia-500 focus:outline-none focus:ring-2 focus:ring-stone-400 focus:ring-offset-2 focus:ring-offset-stone-200 disabled:cursor-not-allowed disabled:bg-stone-600 disabled:text-stone-300',
  };
